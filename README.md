...
Code along based on [Multi Step Form With React & Material UI](https://www.youtube.com/watch?v=zT62eVxShsY) YouTube
...
Install the dependencies (if they haven't already been installed)
...
PhpStorm can be configured to debug javascript.
